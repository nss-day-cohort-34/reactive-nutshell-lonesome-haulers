        ...
        return (
            <div className="card">
               <div className="card-content">
                 ...
                 <p><i>Synopsis: {this.state.articles[0].synopsis}</i></p>
                 <p><i>URL: <a href={this.state.articles[0].url}>{this.props.articles[0].url}</a></i></p>
                 <p><i>Created: {this.state.articles[0].timestamp}</i></p>
               </div>
           </div>
        )
    } else {
